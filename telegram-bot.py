...
ADAFRUIT_IO_USERNAME = os.getenv('pramimadhu')
ADAFRUIT_IO_KEY = os.getenv('aio_ypBp37olOazzGQPouUysTosxdXer')
TOKEN = os.getenv('1302647717:AAEb-fFKn9pR2appQsZtEhkuGblQ2OSIyiU')
...
updater =Updater('1302647717:AAEb-fFKn9pR2appQsZtEhkuGblQ2OSIyiU')
